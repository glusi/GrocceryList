...
class MainChoose : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        courseList = courseList + GridViewModal("Молочное", R.drawable.milk)
        titles.add("Молочное")
        ...
        courseList = courseList + GridViewModal("Соусы, Намазки и Добавки", R.drawable.souse)
        titles.add("Соусы, Намазки и Добавки")
        courseList = courseList + GridViewModal("Сладкое и Напитки", R.drawable.sweet)
        titles.add("Сладкое и Напитки")
        courseList = courseList + GridViewModal("Замороженные Продукты", R.drawable.ice)
        titles.add("Замороженные Продукты")
